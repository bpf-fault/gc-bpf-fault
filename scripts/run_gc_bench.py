...
DEF_JDK = "/mydata/openjdk-mmtk/build/b0test/images/jdk"
DEF_DACAPO = "/mydata/dacapo/dacapo-23.11/dacapo-23.11-MR2-chopin.jar"
...
def parse_run(text, kind):
    ...
    if kind == "pauses":
        ...
        r["passed"] = r["passed"] or r["gcs"] is not None
    return r
